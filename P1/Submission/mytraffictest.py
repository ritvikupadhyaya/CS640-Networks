...
def switch_tests():
    ...
    s.expect(PacketOutputEvent("eth0", testpkt, "eth2", testpkt, display=Ethernet), "The Ethernet frame from 30:00:00:00:00:01 to 30:00:00:00:00:02 should be flooded out eth0 and eth2")
    ...
    # The traffic list is full at this point so to learn eth0, eth2 for src 30:00:00:00:00:04 will be deleted. Hence this will be flooded.
    ...
    s.expect(PacketOutputEvent("eth1", testpkt, "eth2", testpkt, display=Ethernet), "An Ethernet frame from 30:00:00:00:00:05 to 30:00:00:00:00:04 should be flooded out eth1 and eth2")

    # test case 6: Again learnt the eth2 at src 30:00:00:00:00:04 so eth0 at 30:00:00:00:00:05 gets deleted and the packet will be flooded out eth0 and eth1.
    testpkt = mk_pkt("30:00:00:00:00:04", "30:00:00:00:00:05", "192.168.1.4", "192.168.1.5")
    s.expect(PacketInputEvent("eth2", testpkt, display=Ethernet), "An Ethernet frame from 30:00:00:00:00:04 to 30:00:00:00:00:05 should arrive on eth2") 
    s.expect(PacketOutputEvent("eth0", testpkt, "eth1", testpkt, display=Ethernet), "The Ethernet frame from 30:00:00:00:00:04 to 30:00:00:00:00:05 should be flooded out eth0 and eth1")
    return s
